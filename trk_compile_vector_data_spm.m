function [track_means,starting_pts_out,nPts] = trk_compile_vector_data_spm(subsDir,subIDs,tract_info,outDir, saveTrk, saveASCII)
%TRK_COMPILE_DATA_SPM - Compiles along-tract data for subjects/hemispheres/tracts
%
% Syntax: [track_means,starting_pts_out,nPts] = trk_compile_data_spm(subsDir,subIDs,tract_info,outDir,starting_pts_in,saveTrk,saveASCII)
%
% Inputs:
...
%    [track_means,starting_pts_out,nPts] = trk_compile_data_spm(exDir,subIDs,tract_info,[],starting_pts_in,1,1);
%
% Other m-files required: spm_read_vols, spm_vol, trk_read, trk_interp, trk_flip, trk_restruc,
...
if nargin < 5 || isempty(saveTrk), saveTrk = 0; end
...
fprintf(fid2, 'ID\tPoint\tHemisphere\tTract\tdxx\tdxy\tdxz\tdyy\tdyz\tdzz');
