function [track_means,starting_pts_out,nPts] = trk_compile_data_spm(subsDir,subIDs,tract_info,outDir,starting_pts_in, saveTrk, saveASCII)
...
for iTrk=1:length(tract_info)
    ...
    for i=1:length(subIDs)
        ...
        try
            ...
            tracks_interp = trk_restruc(tracks);  % 这里做了一个trick，不再进行interp.因为之前已经做过了。
